...
PUBLIC_FAMILIES = {
    ...
    "dfkv_rdma_recv_segment_chunks",
    "dfkv_rdma_recv_segment_growths_total",
    "dfkv_rdma_recv_segment_shrinks_total",
    "dfkv_rdma_recv_segment_released_bytes_total",
    "dfkv_rdma_recv_segment_chunk_idle_ms",
    ...
    "dfkv_slab_watermark_extent_clears_total",
    "dfkv_slab_watermark_ticks_total",
    "dfkv_slab_watermark_active",
    "dfkv_slab_watermark_last_tick_us",
    "dfkv_slab_watermark_max_tick_us",
    "dfkv_slab_watermark_max_extents_per_tick",
