...
_COUNTERS: dict[str, tuple[str, ...]] = {
    ...
    "dfkv_rdma_client_rail_put_ops_total": ("dev",),
    "dfkv_rdma_client_rail_put_bytes_total": ("dev",),
    "dfkv_rdma_client_rail_get_ops_total": ("dev",),
    "dfkv_rdma_client_rail_get_bytes_total": ("dev",),
